...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'django_sql_dashboards_query', (
            ...
            ('legend_align', self.gf('django.db.models.fields.CharField')(default='right', max_length=64)),
            ('cache_ttl', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.create_table(u'django_sql_dashboards_queryhistory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('query', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_sql_dashboards.Query'])),
        ...
        db.send_create_signal(u'django_sql_dashboards', ['QueryHistory'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'django_sql_dashboards_queryhistory')
