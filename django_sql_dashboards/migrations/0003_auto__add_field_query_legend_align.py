...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Query.legend_align'
        db.add_column(u'django_sql_dashboards_query', 'legend_align',
                      self.gf('django.db.models.fields.CharField')(default='right', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Query.legend_align'
        db.delete_column(u'django_sql_dashboards_query', 'legend_align')
    ...
    models = {
        ...
        u'django_sql_dashboards.query': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'legend_align': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
