...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Query.pivot'
        db.add_column(u'django_sql_dashboards_query', 'pivot',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Query.pivot'
        db.delete_column(u'django_sql_dashboards_query', 'pivot')
    ...
    models = {
        ...
        u'django_sql_dashboards.query': {
            ...
            'pivot': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
