...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Query.cache_ttl'
        db.add_column(u'django_sql_dashboards_query', 'cache_ttl',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Query.cache_ttl'
        db.delete_column(u'django_sql_dashboards_query', 'cache_ttl')
