...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Query.custom'
        db.add_column(u'django_sql_dashboards_query', 'custom',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Query.custom'
        db.delete_column(u'django_sql_dashboards_query', 'custom')
